...
const team = [
  ...
  { name: "Yazh priya", role: "Event marketing planner", desc: "Storyteller in chief, weaving narratives that travel further than the night.", img: member5 },
  ...
  { name: " Darshan Balasubramaniam", role: "Photographer & Editor ", desc: "Dressing every event in curated style — where fashion meets celebration.", img: member11 },
